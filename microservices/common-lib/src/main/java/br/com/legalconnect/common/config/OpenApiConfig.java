        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API para a plataforma de marketplace jurídico LegalConnect. " +
                                ...
                                "incluindo autenticação JWT e regras de autorização.") // Descrição detalhada da API
                        .contact(new Contact()
                        ...
                        .license(new License()
                                ...
                                .url("http://www.apache.org/licenses/LICENSE-2.0.html"))) // URL da licença
                .addSecurityItem(new SecurityRequirement().addList(securitySchemeName)) // Adiciona o requisito de
                                                                                        // segurança global para todos
                                                                                        // os endpoints
                .components(new Components()
                        .addSecuritySchemes(securitySchemeName, new SecurityScheme()
                                ...
                                .description("Autenticação JWT usando Bearer Token. " +
                                        "Insira seu token JWT no formato 'Bearer SEU_TOKEN_AQUI'"))); // Descrição no
                                                                                                      // Swagger UI
    }
}