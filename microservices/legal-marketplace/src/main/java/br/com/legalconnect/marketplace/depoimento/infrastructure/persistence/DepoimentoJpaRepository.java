...
public interface DepoimentoJpaRepository extends JpaRepository<Depoimento, UUID> {
    ...
    /**
     * Busca uma lista de depoimentos aleatórios, limitada pela quantidade especificada, apenas os APROVADOS.
    ...
    /**
     * Busca os 5 depoimentos APROVADOS mais recentes, ordenados pela data de criação em ordem decrescente.
